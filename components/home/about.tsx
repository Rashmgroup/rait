...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        We are passionate educators and teachers, dedicated to bridging the gap in students&apos; learning, helping them connect theory with practice and empowering them to reach their full potential.{" "}
      </span>
      <span
      ...
      >
       We take pride in our responsibility to nurture not only well-educated individuals but also good, ethical people.
      </span>
    </h1>
  );
