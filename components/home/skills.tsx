...
const SkillsSection = () => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      <p className="section-title-sm seq">Company</p>
      <h1 className="section-heading seq mt-2">For Top Placement</h1>
      <h2 className="text-2xl md:max-w-2xl w-full seq mt-2">
        I like to take responsibility to you will get job in TOP MNC&apos;s company.{" "}
      </h2>
    </div>
  );
    ...
    <section className="relative">
      ...
      >
        <div className="flex flex-col skills-wrapper">
          {renderSectionTitle()}
          <div className="mt-10">
            {renderSkillColumn("PRODUCT BASED COMPANY", SKILLS.company)}
          </div>
          {/* <div className="flex flex-wrap mt-10">
            ...
            <div>{renderSkillColumn("Other Companys", SKILLS.other)}</div>
          </div> */}
        </div>
      </div>
    </section>
