...
const CollaborationSection = () => {
  ...
  const renderTitle = () => (
    ...
    >
      Conguralations on 🎉 You are <span className="text-strong font-bold">Part of RAIT </span>
      !
    </h1>
  );
  ...
  return (
    <section className={COLLABORATION_STYLE.SECTION} ref={targetSection}>
      {renderSlidingText(
        " C JavaScript C++ Python Ardunio HTML CSS ",
        "ui-left"
      )}
      ...
      {renderSlidingText(
        " Tally Excel Basic MS-Office Typing CoralDraw ",
